...
wow.init();
var arr_img = ["img/bg-student.jpg", "img/bg-teacher.jpg"]
var arr_dot = []
...
for (i = 0; i < arr_re.length; i++) {
    $('.inside_img_box').append(`
<div class='img${i}' style="background: url(${arr_re[i]});"></div>
    `)
...
$('.inside_img_box').append(`      <video loop poster width="320" height="200">
<source src="img/ONECLASS_20191204.mp4" type="video/mp4" />

<source src="img/ONECLASS_20191204.mp4" type="video/webm" />
</video>
`)
$('video').attr('width',1920*1.15)

$('video').attr('height',900*1.15)
$('video').css('transform',"translate(20%,-10%)")
$('video').css('zIndex',"-3")
